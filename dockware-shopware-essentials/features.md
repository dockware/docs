...
Please see this page for more: [releases-and-versions.md](../dockware-web/releases-and-versions.md "mention")
{% endhint %}
...
{% hint style="info" %}
If you don't need this, please refer to the default SSH credentials: [default-credentials.md](../dockware-web/default-credentials.md "mention")
{% endhint %}
...
We do also have additional environment variables, that you can use for further configuration. Please see our section about [environment-variables.md](../dockware-web/environment-variables.md "mention")for more.
