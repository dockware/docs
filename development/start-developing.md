...
You can immediately access the database with the exposed port **3306** \(see [FAQ](../faq/intro.md) for more\).  
...
If you need the SSH/SFTP credentials, please see the [FAQ](../faq/intro.md) section for details.  
